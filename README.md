...
than a big-bang dump. It's a working demo of agent-driven development where the
*process* — tickets, gates, and review — is as much the artifact as the code.
Those figures are a dated snapshot, regenerated by `scripts/probe/repo-stats.mjs`
...
npm test            # vitest — 1303 tests in 84 files (2026-07-27) across every logic layer
