...
**Branch protection:** `main` is protected by a GitHub ruleset (id `18084578`) that enforces all three CI checks (`gate`, `branch-name`, `review`) and requires a PR — direct pushes are blocked at the GitHub level.
